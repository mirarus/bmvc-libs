...
interface IMError
{
	...
	public static function print($text, $message = null, bool $html = false, string $title = null, string $color = null, bool $stop = false, int $response_code = 200): void; // @phpstan-ignore-line
  public static function set(array $array): _MError; // @phpstan-ignore-line
