...
class Str
{
	 ...
	 * @return bool
	 */
	public static function in_array_insensitive($needle, array $haystack, bool $strict = false): bool
	{
		if (is_string($needle)) {
	 ...
	 * @return bool
	 */
	public static function mb_in_array_insensitive($needle, array $haystack, bool $strict = false, ?string $encoding = null): bool
	{
		if (null === $encoding) {
			$encoding = mb_internal_encoding();
		}
		if (is_string($needle)) {
			return in_array(mb_strtolower($needle, $encoding), array_map(function ($value) use ($encoding) {
